...
import com.jfxbase.oopjfxbase.controllers.InsertWorkout;
...
public class ApplicationHandler {
    ...
    public void navigateToInsertWorkout() {
        try {
            this.views.put(SCENE_IDENTIFIER.InsertWorkoutPage, FXMLLoader.load(Objects.requireNonNull(JFXBaseApplication.class.getResource("InsertWorkout.fxml"))));
            this.changeScene(SCENE_IDENTIFIER.InsertWorkoutPage);
    ...
    public void navigateToCalendar() {
        try {
            this.views.put(SCENE_IDENTIFIER.FirstPage, FXMLLoader.load(Objects.requireNonNull(JFXBaseApplication.class.getResource("CalendarView.fxml"))));
            this.changeScene(SCENE_IDENTIFIER.FirstPage);
    ...
    public void navigateToAccount() {
        try {
            this.views.put(SCENE_IDENTIFIER.AccountPage, FXMLLoader.load(Objects.requireNonNull(JFXBaseApplication.class.getResource("AccountPage.fxml"))));
            this.changeScene(SCENE_IDENTIFIER.AccountPage);
